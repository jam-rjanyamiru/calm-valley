...
class Settings_Appearance {
	...
	private function add_settings_sections() {
		...
		add_settings_section(
			...
			__( 'Appearance settings', 'woocommerce-easy-booking-system' ),
	...
	public function appearance_settings_section() {
		echo '<p>' . __( 'Customize the calendar so it looks great with your theme!', 'woocommerce-easy-booking-system' ) . '</br>' . __( 'For better rendering, prefer a light background and a dark text color.', 'woocommerce-easy-booking-system' ) . '</p>';
	}
	...
	public function calendar_theme() {
		...
		Settings::select( array(
			...
			'options'     => array(
				'default' => __( 'Default', 'woocommerce-easy-booking-system' ),
				'classic' => __( 'Classic', 'woocommerce-easy-booking-system' )
			)
		));
...
return new Settings_Appearance();