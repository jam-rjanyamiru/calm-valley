<?php
/**
 * The template for displaying datepickers on the product page.
 *
 * This template can be overridden by copying it to yourtheme/easy-booking/wceb-html-single-product.php.
