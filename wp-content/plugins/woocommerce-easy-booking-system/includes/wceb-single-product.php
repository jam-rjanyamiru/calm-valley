...
function wceb_loop_add_to_cart_link( $content, $product ) {
    ...
    if ( wceb_is_bookable( $product ) ) {
        ...
        $text = apply_filters_deprecated( 'wceb_bookable_product_add_to_cart_text', array( __( 'Select date(s)', 'woocommerce-easy-booking-system' ), $product ), '2.2.7', 'easy_booking_select_dates_text' );
