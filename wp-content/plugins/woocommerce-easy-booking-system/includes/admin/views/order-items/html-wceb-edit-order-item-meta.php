        ...
        <tbody class="meta_items">
            ...
            <tr data-meta_id="<?php echo esc_attr( $start_date_meta_id ); ?>">
                ...
                <td>
                    ...
                    <input type="text"  name="meta_value[<?php echo esc_attr( $item_id ); ?>][<?php echo esc_attr( $start_date_meta_id ); ?>]" id="start_date" class="datepicker datepicker_start--<?php echo absint( $item_id ); ?>" value="<?php echo esc_attr( $start_date ); ?>" data-value="<?php echo esc_attr( $start_date ); ?>">
            ...
            <?php if ( wceb_get_product_number_of_dates_to_select( $product ) === 'two' ) : ?>
                ...
                <tr data-meta_id="<?php echo esc_attr( $end_date_meta_id ); ?>">
                    ...
                    <td>
                        ...
                        <input type="text" name="meta_value[<?php echo esc_attr( $item_id ); ?>][<?php echo esc_attr( $end_date_meta_id ); ?>]" id="end_date" class="datepicker datepicker_end--<?php echo absint( $item_id ); ?>" value="<?php echo esc_attr( $end_date ); ?>" data-value="<?php echo esc_attr( $end_date ); ?>">
